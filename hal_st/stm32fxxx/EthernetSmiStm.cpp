...
namespace hal
{
    ...
    {
        peripheralEthernet[0]->MACMIIAR = (peripheralEthernet[0]->MACMIIAR & ~ETH_MACMIIAR_CR_Msk) | ((static_cast<uint32_t>(phyAddress) << 11) & ETH_MACMIIAR_PA) | ((static_cast<uint32_t>(reg) << 6) & ETH_MACMIIAR_MR) | ETH_MACMIIAR_MB;
    ...
    void EthernetSmiStm::WritePhyRegister(uint16_t reg, uint16_t value)
    {
        ...
        peripheralEthernet[0]->MACMIIAR = (peripheralEthernet[0]->MACMIIAR & ~ETH_MACMIIAR_CR_Msk) | ((static_cast<uint32_t>(phyAddress) << 11) & ETH_MACMIIAR_PA) | ((static_cast<uint32_t>(reg) << 6) & ETH_MACMIIAR_MR) | ETH_MACMIIAR_MW | ETH_MACMIIAR_MB;
