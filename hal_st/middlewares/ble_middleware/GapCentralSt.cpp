...
namespace hal
{
    ...
    void GapCentralSt::HandlePassKeyRequestEvent(const aci_gap_pass_key_req_event_rp0& event)
    {
        ...
        auto peerIoCapability = static_cast<services::GapPairing::IoCapabilities>(event.IO_Capability);

        bool shouldDisplay = (ioCapabilities == services::GapPairing::IoCapabilities::display ||
                              ioCapabilities == services::GapPairing::IoCapabilities::displayYesNo ||
                              (ioCapabilities == services::GapPairing::IoCapabilities::keyboardDisplay &&
                                  (peerIoCapability == services::GapPairing::IoCapabilities::keyboard ||
                                      peerIoCapability == services::GapPairing::IoCapabilities::keyboardDisplay)));
