...
namespace hal
{
    ...
    void GapPeripheralSt::Initialize(const GapService& gapService)
    {
        ...
        SetManInTheMiddleMode(services::GapPairing::ManInTheMiddleMode::disabled);             // TODO: check for reasonable defaults
        SetSecureConnectionMode(services::GapPairing::SecureConnectionMode::optionalSecurity); // TODO: check for reasonable defaults
