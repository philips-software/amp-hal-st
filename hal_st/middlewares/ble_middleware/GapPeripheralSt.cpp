...
namespace hal
{
    ...
    void GapPeripheralSt::Initialize(const GapService& gapService)
    {
        ...
        SetSecurityRequirements(services::GapPairing::SecureConnectionMode::optionalSecurity, services::GapPairing::ManInTheMiddleMode::disabled); // TODO: check for reasonable defaults
