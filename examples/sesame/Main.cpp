...
#elif SECURE_DIFFIE_HELLMAN
    services::EchoPolicyDiffieHellman::KeyMaterial keyMaterial{ key_material::deviceCertificate, key_material::deviceCertificatePrivateKey, key_material::rootCaCertificate };
